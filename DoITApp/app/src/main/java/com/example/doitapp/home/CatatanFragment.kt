...
class CatatanFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_catatan, container, false)

        val history = v.findViewById<RecyclerView>(R.id.historyRecyView)
        history.layoutManager = LinearLayoutManager(v.context)
